...
export interface ApiPhotoshootPhotoshoot extends Schema.CollectionType {
  collectionName: 'photoshoots';
  info: {
    singularName: 'photoshoot';
    pluralName: 'photoshoots';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::photoshoot.photoshoot': ApiPhotoshootPhotoshoot;
